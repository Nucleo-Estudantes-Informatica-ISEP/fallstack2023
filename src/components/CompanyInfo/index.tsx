  ...
  return (
    <section className="mx-auto w-11/12 rounded-lg bg-white p-10 sm:w-3/4 lg:p-14">
        ...
        <CompanyDescription>
          ...
          <div
            className="
                            ...
                            my-2.5 text-left font-light text-black
                            md:text-lg
                            lg:text-xl
                         "
          >
      ...
      {facts && (
        <section
          className="
                        my-5 flex flex-col space-y-2 text-sm
                        font-light leading-8 sm:text-sm lg:px-10
                        lg:text-lg
                    "
        >
          {facts.map((fact, i) => (
            <div key={i} className="my-2 flex flex-row items-center">
              <fact.iconSrc
                className="
                                    h-6 w-6 fill-stone-500 sm:h-6 sm:w-6 md:h-8 md:w-8 lg:h-8
                                    lg:w-8
"
              />
              <p className="ml-2 text-left text-black">{fact.description}</p>
            </div>
          ))}
        </section>
      )}
