  ...
  return (
    <footer className="w-full text-center">
      <div className="flex justify-center drop-shadow-lg hover:drop-shadow-xl lg:m-8">
        <div className="my-6 w-max  transition-all duration-300 hover:scale-105">
          <a href={lastEditionUrl} target="_blank" rel="noreferrer">
            <div className="rounded-2xl bg-secondary p-6 lg:p-7 font-poppins font-bold text-2xl drop-shadow-3xl transition-all duration-300 sm:text-[2.5rem] lg:text-[3.5rem]">
              Edição Anterior
            </div>
          </a>
        </div>
      ...
      <div className="lg:flex justify-between lg:pb-6">
        <h4 className="select-none sm:text-center lg:pb-0 pb-3 right-10 lg:pl-20">
