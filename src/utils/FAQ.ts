...
export const FAQ: FaqProps[] = [
    ...
    },
    {
        ...
        answer: "Começando este ano (2023), o processo de inscrição é realizado a partir da nossa plataforma oficial do evento. Basta seguires os passos indicados para a criação de uma conta e ficas automaticamente registado para o evento."
    },
    {
    ...
    },
    {
        ...
        answer: "Sim. As faltas serão justificadas a todos os estudantes do 3o Ano de Licenciatura de Engenharia Informática excetuando aulas em que se realizem avaliações ou outros momentos inadiáveis."
    },
    {
