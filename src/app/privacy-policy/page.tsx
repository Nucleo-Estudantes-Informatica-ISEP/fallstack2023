    ...
    <section className="w-full px-8 py-24 md:px-24">
      ...
      <article className="mt-12">
        ...
        <p className="mt-2">
          ...
          interação dos utilizadores com as empresas participantes no evento.
          Esta prática está alinhada com as disposições legais do Regulamento
      ...
      <article className="mt-12">
        ...
        <p className="mt-2">
          Os utilizadores têm o direito de aceder aos seus dados (Artigo 15° do
          RGPD), retificar as informações (Artigo 16° do RGPD), efetuar a
      ...
      <article className="mt-12">
        ...
        <p className="mt-2">
          Os utilizadores serão notificados em caso de alterações na Política de
          Privacidade, e estas serão comunicadas de forma clara na aplicação.
        </p>
      </article>
